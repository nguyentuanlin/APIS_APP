...
import { scheduleService, ScheduleItem, StudentInfo } from '../../services/sinhVien/scheduleService';
import AttendanceModal from '../../components/AttendanceModal';

import attendanceService from '../../services/sinhVien/attendanceService';
type ClassStudent = {
  ID: string;
